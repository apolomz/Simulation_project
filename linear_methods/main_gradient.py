...
def main():
    ...
    for it in range(MAX_ITERACIONES_NEWTON):
        ...
        # Resolver usando Gradiente Descendiente
        delta_X = gradient_descent(J, -F)
    ...
    # Mostrar resultado
    plot_velocity_field(vx_copy, method_name="Método Gradiente Descendiente")
